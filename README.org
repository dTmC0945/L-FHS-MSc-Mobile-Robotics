...
#+title: LS FHS MSc Mobile Robotics
...
|-------+--------------------+-------------------------------------+--------|
|     2 | Lecture Code       | Mobile Robotik                      | A      |
|     3 | Module Code        | Mobile Robotik                      | A      |
|     4 | Degree             | M.Sc                                | A      |
|     5 | Program Name       | Industrial Informatics and Robotics | A      |
|     6 | Lecture Name       | Mobile Robotics                     |        |
|     7 | Semester           | 4                                   | A      |
|     8 | Season             | SS                                  | A      |
|     9 | Room Type          | Lecture Room                        |        |
|    10 | Assignments        | Personal Assignment A               | A      |
|    11 | Lecturer           | Daniel T. McGuiness, Ph.D           |        |
|    12 | Module Responsible | -                                   | A      |
|-------+--------------------+-------------------------------------+--------|
